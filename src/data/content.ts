export const content = {
  en: {
    ...
    coordinator: {
      ...
      designation: "HOD Department of Information Technology, HIT Haldia, WB, India"
    },
      ...
      list: [
        {
          ...
          designation: "Honorable Vice Chairman, HIT Haldia, WB, India"
        },
        {
          name: "Mr. Ashish Lahiri",
          designation: "Honorable Secretary, ICARE, WB, India"
        },
        {
          name: "Prof. (Dr.) Tarun Kanti Jana",
          designation: "Honorable Principal, HIT Haldia, WB, India"
        },
        {
          name: "Dr. Anjan Mishra",
          designation: "Honorable Registrar General, HIT Haldia, WB, India"
        }
      ]
    },
     organizingCommittee: {
  ...
  { time: "2:15 PM - 3:45 PM", topic: "Industrial Al: Industrial Deployment of Cyber Physical Systems By Mr. Aninda Sankar Sukla", speaker: "Senior Data Scientist Manager at Sirius Digitech International Limited (an Adani IHC Joint Venture)" },
  ...
  bn: {
    ...
    schedule: {
      ...
      day2: {
        title: "দ্বিতীয় দিন",
        sessions: [
          { time: "সকাল ৯:৩০ - ১০:০০", topic: "টি", speaker: "" },
    ...
    institutionDescription: {
      ...
      description: "হলদিয়া ইনস্টিটিউট অফ টেকনোলজি (এইচআইটি হলদিয়া) ভারতের একটি প্রিমিয়ার স্বায়ত্তশাসিত এআইসিটিই অনুমোদিত প্রতিষ্ঠান যেখানে দশটি বিভাগ জুড়ে ইঞ্জিনিয়ারিং প্রোগ্রাম রয়েছে। ১৯৯৬ সালে প্রতিষ্ঠিত এইচআইটি (পশ্চিমবঙ্গের প্রথম বেসরকারি ইঞ্জিনিয়ারিং কলেজ) প্রতিভাবান ইঞ্জিনিয়ার তৈরির সমৃদ্ধ ইতিহাস রয়েছে।"
    }
  }
};